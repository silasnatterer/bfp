...
# Time stepping
dt_3D = 1e-4            # time step of 3D mechanics
dt_splitting = 1e-5     # time step of strang splitting
dt_1D = 1e-5            # time step of 1D fiber diffusion
dt_0D = 1e-6            # time step of 0D cellml problem
end_time = .02          # end time of the simulation 
output_interval = 1e-5  # time interval between outputs
...
# Meshes
ex_x, ex_y, ex_z = .015, .015, .06                # extent of muscle
...
specific_states_call_enable_begin = .005                     # time of first fiber activation
