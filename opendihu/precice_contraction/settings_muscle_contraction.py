...
config = {
  ...
  "logFormat":                      "csv",
  "mappingsBetweenMeshesLogFile":   "out/" + scenario_name + "/muscle_contraction/mappings_between_meshes_log.txt",
  "solverStructureDiagramFile":     "out/" + scenario_name + "/muscle_contraction/solver_structure_diagram.txt",
  ...
  "PreciceAdapterVolumeCoupling": {
    ...
    "MuscleContractionSolver": {
      ...
      "OutputWriter": [
        {
          ...
          "filename":           "out/" + scenario_name + "/muscle_contraction/mechanics",
      ...
      "DynamicHyperelasticitySolver": { 
        ...
        "dirichletOutputFilename":    "out/" + scenario_name + "/muscle_contraction/dirichlet_output",
        "residualNormLogFilename":    "out/" + scenario_name + "/muscle_contraction/residual_norm_log.txt",
        "totalForceLogFilename":      "out/" + scenario_name + "/muscle_contraction/total_force_log.txt",
